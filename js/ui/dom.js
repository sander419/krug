...
/* Число со знаком: «+2,1» и «−2,1». Минус — типографский, как в полосе метрик
   и в подписях сцены; `toLocaleString` отдаёт дефис, и в одном интерфейсе
   получались два разных минуса. */
export const signed = (v, d = 1, fmt = num) =>
