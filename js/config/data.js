...
// origin — где у машины ноль стола. У портальных (декартовых) он в углу,
// у дельты — в центре. От этого зависит, куда слайсер кладёт траекторию:
// файл, написанный вокруг нуля, на портальной машине уедет за стол.
export const PRINTERS = [
  {name:'3D PotterBot Micro 10', nozzle:3.0, lh:1.6, feed:1200, cart:48, bed:[152,152,254], origin:'corner', note:'Поршневой экструдер (ram) · жёсткая глина · сопла 1–10 мм'},
  {name:'Delta WASP 40100 LDM',  nozzle:4.0, lh:2.4, feed:1800, cart:20, bed:[400,400,1000], origin:'center', note:'Шнек + пневмоподача · влажная паста · непрерывная подача'},
  {name:'Vormvrij Lutum 4M',     nozzle:0.8, lh:0.4, feed:900,  cart:25, bed:[300,300,400], origin:'corner', note:'Стальной шнек V10 · шамот до 25% · разрешение 0.2 мм'},
];
